                ...
                <Modal.Body className="p-4">
                    ...
                    {requiresSchoolSelection ? (
                        <>
                                ...
                                {selectedSchoolId ? (
                                    availableSchoolDays.length > 0 ? (
                                        <>
                                            <div className="d-flex flex-wrap gap-2 mb-2">
                                                {availableSchoolDays.map((entry) => (
                                                    <Button
                                                        ...
                                                        type="button"
                                                        size="sm"
                                                        variant={preferredDays.includes(entry.dayOfWeek) ? 'dark' : 'outline-dark'}
                                                        className="rounded-pill"
                                            ...
                                            <div className="text-muted small">Select one or more school days for your preferred class schedule.</div>
                                        </>
                                    ) : (
                            ...
                            <div className="border rounded-4 p-3 mb-3">
                                <div className="fw-semibold mb-2">Preferred Time Slot</div>
                                            ...
                                            {availableSchoolSlots.map((slot) => {
                                                ...
                                                return (
                                                    <Button
                                                        ...
                                                        type="button"
                                                        size="sm"
                                                        variant={preferredTimes.includes(slotValue) ? 'dark' : 'outline-secondary'}
                                                        className="rounded-pill"
                            ...
                            <div className="d-flex flex-wrap gap-2 mb-2">
                                {ENROLLMENT_TIME_SUGGESTIONS.map((slot) => (
                                    <Button
                                        ...
                                        type="button"
                                        size="sm"
                                        variant={preferredTimes.some((item) => item.toLowerCase() === slot.toLowerCase()) ? 'dark' : 'outline-secondary'}
                                        className="rounded-pill"
