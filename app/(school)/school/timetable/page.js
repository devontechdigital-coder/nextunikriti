...
export default function SchoolTimetablePage() {
  ...
  const [filters, setFilters] = useState({ schoolId: schoolId, teacherId: '', batchId: '' });
  ...
  const { data: timetablesData, isLoading: isLoadingTimetables, refetch } = useGetAdminTimetablesQuery(
  ...
  const { data: batchesData } = useGetAdminBatchesQuery({ schoolId });
        ...
        <Card.Body>
          <Row className="g-3">
            ...
            <Col md={4} className="d-flex align-items-end">
               <Button variant="outline-secondary" onClick={() => setFilters({ schoolId: schoolId, teacherId: '', batchId: '' })} className="w-100">
                  Clear Filters
               </Button>
            </Col>
          </Row>
          ...
          <div className="table-responsive">
            <table className="table table-hover align-middle mb-0">
              ...
              <tbody>
                ...
                {timetables.length === 0 && (
                  <tr>
                    <td colSpan={6} className="text-center py-5 text-muted">No timetable entries found.</td>
                  </tr>
                )}
              </tbody>
            </table>
          ...
          {selectedEntry && (
            <div className="d-flex flex-column gap-3">
              ...
              <Row className="g-3">
                 ...
                 <Col xs={6}>
                    <div className="small text-muted mb-1">School ID</div>
                    <div className="fw-bold">{schoolId}</div>
                 </Col>
              </Row>
